...
export class PokeListComponent implements OnInit {
  ...
  toggleFavorite(pokemon:any): void {
    // Find the Pokémon in the list by matching IDs
    const foundPokemon = this.pokemonList.find(p => p.id === pokemon.id);
    if (foundPokemon) {
      // Toggle the favorite status of the found Pokémon
      foundPokemon.isFavorite = !foundPokemon.isFavorite;
      // Log the updated Pokémon and list for debugging
      // console.log(foundPokemon, this.pokemonList);
    }
